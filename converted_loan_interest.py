...
# IS-VIP-ACCOUNT -> ws_vip_flag == "Y"
# IS-STANDARD -> ws_vip_flag == "N"
...
# ======================================================================================================
# VALIDATION REPORT — COBOL <-> PYTHON SIDE-BY-SIDE
# Confidence: 100%  |  0 of 6 statements flagged
# ======================================================================================================
# COBOL                                          PYTHON                                         STATUS
# ---------------------------------------------- ---------------------------------------------- ------
# IF IS-VIP-ACCOUNT                              if ws_vip_flag == "Y":                         [OK]  
# COMPUTE WS-DAILY-RATE=WS-ANNUAL-RATE/WS-DAYS-  ws_daily_rate = ws_annual_rate / ws_days_in_y  [OK]  
# IF IS-VIP-ACCOUNT                              if ws_vip_flag == "Y":                         [OK]  
# COMPUTE WS-TEMP-AMOUNT=WS-PRINCIPAL-BAL*WS-DA  ws_temp_amount = ws_principal_bal * ws_daily_  [OK]  
# COMPUTE WS-DAILY-INTEREST=FUNCTIONINTEGER(WS-  ws_daily_interest = int(ws_temp_amount * Deci  [OK]  
# IF WS-DAYS-OVERDUE>WS-GRACE-PERIOD             if ws_days_overdue > ws_grace_period:          [OK]  