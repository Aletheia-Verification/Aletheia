...
==========================================================================================
  ...
  Compile success    : 198/200 (99.0%)
  Clean (0 MR)       : 190/200 (95.0%)
  With MANUAL REVIEW : 10 programs, 66 total flags

  PVR (Parse-Verify Rate) = 95.0%
  ...
  REG-OFAC-MATCH              112     OK    OK  FAIL    4 COMPILE ERROR: invalid decimal
  REG-RISK-WEIGHT              96     OK    OK    OK    0 VERIFIED                      
  REG-SAR-SCREEN              100     OK    OK    OK    0 VERIFIED                      
  REG-STRESS-CALC              98     OK    OK    OK    0 VERIFIED                      
  REG-TIN-VALIDATOR           111     OK    OK  FAIL    1 COMPILE ERROR: invalid syntax.
  ...
  TRADE-CUSTODY-FEE            89     OK    OK    OK    3 3 MANUAL REVIEW flags         
  ...
  MR-ALTER-RECOVERY: # ALTER ERROR-HANDLER                            # MANUAL REVIEW                                [FAI
  MR-ALTER-RECOVERY: # ALTER ERROR-HANDLER                            # MANUAL REVIEW                                [FAI
  REG-OFAC-MATCH: # MANUAL REVIEW: Nested IF
  REG-OFAC-MATCH: # MANUAL REVIEW: Nested IF
  REG-OFAC-MATCH: # MANUAL REVIEW: Nested IF
  REG-OFAC-MATCH: # MANUAL REVIEW: INSPECTWS-SDN-NAME(WS-SDN-IDX)TALLYINGWS-WORD-COUNTFORALLWS-
  REG-TIN-VALIDATOR: # MANUAL REVIEW: Nested IF
  TRADE-CUSTODY-FEE: # MANUAL REVIEW: Nested IF
  TRADE-CUSTODY-FEE: # MANUAL REVIEW: MOVE0.0025TOWS-AS-FEE-RATE(WS-AS-IDX)ELSEIFWS-AS-TYPE(WS-AS-
  TRADE-CUSTODY-FEE: # MANUAL REVIEW: MOVE0.0015TOWS-AS-FEE-RATE(WS-AS-IDX)ELSEMOVE0.0020TOWS-AS-F

==========================================================================================
  PVR = 95.0%  (190 clean / 200 tested)
==========================================================================================
